...
void Print_Dec(unsigned short n){
  if(n < 10){
    //Nokia5110_OutString("    ");
    Print_Char(n+'0'); /* n is between 0 and 9 */
  } else if(n<100){
    //Nokia5110_OutString("   ");
    Print_Char(n/10+'0'); /* tens digit */
		lcdwrite(DATA, 0x00);                 // blank vertical line padding
    Print_Char(n%10+'0'); /* ones digit */
  } else if(n<1000){
    //Nokia5110_OutString("  ");
    Print_Char(n/100+'0'); /* hundreds digit */
		lcdwrite(DATA, 0x00);                 // blank vertical line padding
    n = n%100;
    Print_Char(n/10+'0'); /* tens digit */
		lcdwrite(DATA, 0x00);                 // blank vertical line padding
    ...
    //Nokia5110_OutChar(' ');
    Print_Char(n/1000+'0'); /* thousands digit */
		lcdwrite(DATA, 0x00);                 // blank vertical line padding
    n = n%1000;
    Print_Char(n/100+'0'); /* hundreds digit */
		lcdwrite(DATA, 0x00);                 // blank vertical line padding
    ...
    Print_Char(n/10000+'0'); /* ten-thousands digit */
		lcdwrite(DATA, 0x00);                 // blank vertical line padding
    n = n%10000;
    Print_Char(n/1000+'0'); /* thousands digit */
		lcdwrite(DATA, 0x00);                 // blank vertical line padding
